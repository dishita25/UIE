...
def get_config():
    ...
    parser.add_argument("--blur_image_path", type=str, default="/kaggle/input/euvp-dataset/Paired/underwater_dark/trainA/264286_00007889.jpg", help="Path to the blurry input image for the generator.")
