...
class GeneratorFunieGAN(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=3, channels=[36, 36, 72, 144, 288], heads=[1, 2, 4, 8, 16]):
        ...
        self.HVD_block4 = UNetUp(ch5, ch4/2)      # 288 to 144 channels, H/8 and W/8
        self.HVD_block3 = UNetUp(ch4, ch3/2)      # 288 to 72 channels, H/4 and W/4
        self.HVD_block2 = UNetUp(ch3, ch2/2)      # 72 to 36 channels, H/2 and W/2
        self.HVD_block1 = UNetUp(ch2, ch1/2)      # 36 to 36 channels, H and W
        ...
        self.ID_block4 = UNetUp(ch5, ch4/2)      # 288 to 144 channels, H/8 and W/8
        self.ID_block3 = UNetUp(ch4, ch3/2)      # 288 to 72 channels, H/4 and W/4
        self.ID_block2 = UNetUp(ch3, ch2/2)      # 72 to 36 channels, H/2 and W/2
        self.ID_block1 = UNetUp(ch2, ch1/2)      # 36 to 36 channels, H and W
